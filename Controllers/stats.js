...
const statsCars = async (req, res) => {
    ...
    return res.status(200).json({success: true, message: "success", data: {users: users.length, medics: medicaments.length , paramedics: parameds.length , reservs: reservations.length ,dons: produits.length }});
